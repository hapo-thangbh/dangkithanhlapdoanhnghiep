        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                        ...
                        <li>
                            ...
                            <ul class="menu">
                                <li>
                                    ...
                                    <a href="#">
                                        <div class="pull-left">
                                            <img src="modules/admin/images/default.jpg" class="img-circle"
                                                alt="User Image">
                                        </div>
                                        <h4>
                                            Support Team
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="{{ asset('storage/images/default.jpg') }}" class="user-image" alt="User Image">
                        <span class="hidden-xs">Supper admin</span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header">
                            <img src="{{ asset('storage/images/default.jpg') }}" class="img-circle" alt="User Image">
